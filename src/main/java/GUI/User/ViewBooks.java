...
public class ViewBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BookID", "Category", "Name", "Author", "Quantity", "Price", "Copies", "Image"
            }
        ));
    ...
    private void tableMouse(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouse
        ...
        if (row != -1) {
            ...
            byte[] imageBytes = (byte[]) jTable1.getValueAt(row, 7);
    ...
    public void fetchData() {
        ...
        try (
            ...
            for (Books book : books) {
                ...
                photo = book.getImage();
                model.addRow(new Object[]{bookId, category, name, author, quantity, price, copies, photo});
            }
